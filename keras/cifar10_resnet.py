...
log_d = 'logs'
log_dir = create_folder(log_d)
tf_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir)


callbacks = [cp_callback, tf_callback, lr_reducer, lr_scheduler]
...
if not data_augmentation:
    ...
    fit_history = model.fit_generator(datagen.flow(x_train, y_train, batch_size=batch_size),
                        validation_data=(x_test, y_test),steps_per_epoch=int(len(x_train)/batch_size),
